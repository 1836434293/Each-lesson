<template>
    <div>
        ...
        <div class="courses_Introduction">
            ...
            <!-- <div style="font-size:0.37rem" v-html="this.course_details"></div>  正式端口的数据 -->
            <div style="font-size:0.37rem">{{this.course_details | details}}</div>   <!-- 测试端口的数据 -->
        </div>
        ...
        <div class="courses_Introduction">
            ...
            <div class="courses_Introduction_dian">
                ...
                <!-- <div style="font-size:0.35rem" v-html="this.course_details"></div>   正式端口的数据  -->
                <div style="font-size:0.35rem">{{this.course_details | details}}</div>    <!-- 测试端口的数据 -->
            </div>
        </div>
        ...
        <div ref="btn" class="courses_footer" @click="Registration"> 
            立即报名
        </div>
...
export default {
    data(){
        return{
            ...
            pageYOffset:false,
            pageYOffsetIndex:0,
            initQCode: 'https://wap.365msmk.com/course-detail?id=106&courseType=2',    //二维码
            show:false
        }
    },
    created(){
    ...
    methods:{
        ...
        Registration(){
            this.http.post('/api/app/order/downOrder',{shop_id: this.$route.query.id, type: this.$route.query.course_type}).then((resp)=>{
                window.console.log(resp)
                if(resp.data.code != 200){
                    alert(resp.data.msg)
                    return
